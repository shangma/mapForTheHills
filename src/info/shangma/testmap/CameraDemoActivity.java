 ...
 */
public class CameraDemoActivity extends FragmentActivity implements OnMapReadyCallback, OnCameraChangeListener {
    ...
    public void onGoToBondi(View view) {
        ...
        changeCamera(CameraUpdateFactory.newCameraPosition(THEHILLS));
	...
	public void onCameraChange(CameraPosition position) {
		...
		final LatLng currentLocation = position.target;
		currentZoom = position.zoom;	// get current zoom level

		Log.d(TAG, "current location is: " + currentLocation.latitude + " ; " + currentLocation.longitude);

        if (currentZoom < PREFERRED_ZOOM_LEVEL) {
			this.zoomIn();
		}

		if (currentLocation.equals(theHillsLatLng)) {
			Log.d(TAG, "I got the hills");
		}
		
        Log.d(TAG, "current zoom level is: " + currentZoom);
	}
}
